...
export const TUTORIAL_STEPS: Record<TutorialStep, {
  ...
  'interpret-sound': {
    ...
    description: 'Listen carefully! The game uses binaural 3D audio with HRTF to help you locate targets. LEFT/RIGHT tells you horizontal position, PITCH indicates direction (higher pitch = target ABOVE where you pinged, lower pitch = target BELOW), and VOLUME shows distance. With headphones, you can also sense depth and direction naturally.',
    action: 'Got it',
  },
  'audio-cues': {
    title: 'Understanding 3D Audio 🎧',
    description: 'Click each of the 8 demo pings to hear how different positions sound. The first 4 demonstrate isolated cues, while the corners show how LEFT/RIGHT (panning), VOLUME (distance), and PITCH (direction: higher = target above, lower = target below) combine to create 3D audio. Try the corners to hear combinations!',
    action: 'Continue',
  },
  'multiple-pings': {
