  ...
  return (
    <div className="space-y-4 animate-scale-in">
      ...
      <div className="text-xs text-muted-foreground space-y-1">
        ...
        <p>• <span className="font-medium">Time Performance:</span> Fast times (&lt;15s) earn bonuses, 15-45s neutral zone, slow times (&gt;45s) get penalties</p>
        ...
        <p>• <span className="font-medium">Achieve B rank or better</span> (500+ points) to progress to the next level</p>
      </div>
    </div>
  );
}
