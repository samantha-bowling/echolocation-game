    ...
    <Dialog open={open} onOpenChange={(isOpen) => !isOpen && handleClose()}>
      <DialogContent className="max-w-2xl p-0 overflow-hidden">
        ...
        >
          ...
          {/* Navigation arrows - only show if not on first or last slide */}
          {currentSlide > 0 && <CarouselPrevious className="left-4" />}
          {currentSlide < 2 && <CarouselNext className="right-4" />}
        </Carousel>
